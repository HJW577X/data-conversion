...
data1 = pd.read_csv("tableA.csv")
data1 = np.array(data1)
# data1 = np.nan_to_num(data1, nan=None)
data2 = pd.read_csv("tableB.csv")
data2 = np.array(data2)
# data2 = np.nan_to_num(data2, nan=None)
data3 = pd.read_csv("matches.csv")
...
outfile = open('restaurant.txt', 'w', encoding='utf-8')
for i in range(len(entity_type1)):
...
outfile = open('address.txt', 'w', encoding='utf-8')
for i in range(len(entity_type2_new)):
...
outfile = open('city.txt', 'w', encoding='utf-8')
for i in range(len(entity_type3)):
...
address_city = []
outfile = open('restaurant-address.txt', 'w', encoding='utf-8')
for i in range(len(entity_type1)):
...
outfile = open('address-city.txt', 'w', encoding='utf-8')
